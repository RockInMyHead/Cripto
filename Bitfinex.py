...
buy = True
sell = False
site = "https://www.okx.com/ru/trade-spot/eth-usdt"
...
time.sleep(50)
def check():
    driver.get("https://www.okx.com/ru/trade-spot/eth-usdt")
...
while i2 == True:
    ...
    print (prise_1)
    nl += 1
    kommission = prise_1 * 0.00001
    kommission = kommission * 0.0018
    kommission = kommission + kommission
    print ("Комиссия состовляет : " + str(kommission)) 
    for i in list_prise:
        if prise_1 > (i+kommission):
            ps = prise_1
            ps2 = format(ps, ',d')
            prise_tin3_3 = driver.find_element_by_xpath("/html/body/div[1]/div/div/div[2]/div/div[1]/div[2]/div/div[2]/div[1]/div[1]/div[2]/div/div/input").send_keys(Keys.CONTROL + "a")
            prise_tin3_1 = driver.find_element_by_xpath("/html/body/div[1]/div/div/div[2]/div/div[1]/div[2]/div/div[2]/div[1]/div[1]/div[2]/div/div/input").send_keys(Keys.DELETE)
            prise_tin3_1 = driver.find_element_by_xpath("/html/body/div[1]/div/div/div[2]/div/div[1]/div[2]/div/div[2]/div[1]/div[1]/div[2]/div/div/input").send_keys(prise_tin3)
            sell = driver.find_element_by_xpath("/html/body/div[1]/div/div/div[2]/div/div[1]/div[2]/div/div[2]/div[2]/div[8]/div").click()
            time.sleep(2)
            buy = driver.find_element_by_xpath("/html/body/div[10]/div/div[3]/div/button[2]").click()
            print ("Старая цена: " + str(i) + "  Новая цена: " + str(prise_1) + "Выстовляю на продажу за: " + str(prise_tin3))
            list_prise.remove(i)
    flag_buy += 1
    if flag_buy % 5 == 0:
        if prise_2 > prise_1 and prise_2 != 0:
            ...
            prise_tin3_1 = driver.find_element_by_xpath("/html/body/div[1]/div/div/div[2]/div/div[1]/div[2]/div/div[2]/div[1]/div[1]/div[2]/div/div/input").send_keys(Keys.DELETE)
            prise_tin3_1 = driver.find_element_by_xpath("/html/body/div[1]/div/div/div[2]/div/div[1]/div[2]/div/div[2]/div[1]/div[1]/div[2]/div/div/input").send_keys(prise_tin3)
            buy = driver.find_element_by_xpath("/html/body/div[1]/div/div/div[2]/div/div[1]/div[2]/div/div[2]/div[1]/div[8]/div").click()
            time.sleep(2)
            buy = driver.find_element_by_xpath("/html/body/div[9]/div/div[3]/div/button[2]").click()
            print ("Старая цена: " + str(prise_2) + "  Новая цена: " + str(prise_1) + "Выстовляю на покупку за: " + prise_tin3)
